...
# A data-module preserves the upstream ESM intact and works from file://.
# Include it in both entry points, including a standalone copy shared without vendor/.
three = (root / 'vendor/three.module.js').read_text(encoding='utf-8').encode('utf-8')
three_loader = ('/** @license Copyright 2010-2023 Three.js Authors; SPDX-License-Identifier: MIT */\n'
                '// Generated by build.py from the unmodified vendored module.\n'
                'const RIG_THREE_URL = "data:text/javascript;base64,'
                + base64.b64encode(three).decode('ascii') + '";\n')
(root / 'vendor/three-source.js').write_text(three_loader, encoding='utf-8')

# Filer i afhængigheds-rækkefølge (afhængigheder først, main.js sidst).
ORDER = [
    'vendor/three-source.js',
